// Array of icons
const icons = ['icon1.png', 'icon2.png', 'icon3.png', 'icon4.png', 'icon5.png'];
...
function spin() {
    if (coins < 1) {
        document.getElementById('message').textContent = "No more coins! Please click Reload to play again.";
        return;
    }
